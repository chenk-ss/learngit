...
if __name__ == '__main__':
    ...
    os.chdir('1024')
    url = 'https://cl.a9j.xyz/thread0806.php?fid=16&search=&page=1'  #默认爬取第一个页面，毕竟要注意身体，需要多个页面的话，自己加个for循环也不是什么难事~
    urlhead = 'https://cl.a9j.xyz/'   #页面解析出来的连接前面需要加上这个头才能打开，根据多年经验这个头是会变的，如果哪天不能用了自己看下是不是这个头变了
    res = url_open(url)
    res.encoding = 'gbk'
